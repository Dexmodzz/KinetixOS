...
static const unsigned int gappx     = 10;       /* gap in pixels around/between windows in the dwindle layout */
...
static const int defaultlayout = 3;  /* index into layouts[] used on startup (3 = dwindle, like Hyprland) */
