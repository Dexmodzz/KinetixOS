...
[[ $(id -u) == 0 && -f /etc/kinetixos-factory-target && $(uname -m) == x86_64 ]]
work=$(mktemp -d)
...
install -m 0644 /usr/share/kinetixos-image/docs/licenses/starship-LICENSE /usr/local/share/doc/starship/LICENSE
install -m 0644 /usr/share/kinetixos-image/docs/licenses/herdr-LICENSE /usr/local/share/doc/herdr/LICENSE
...
sha256sum /usr/local/bin/starship /usr/local/bin/herdr \
	>/usr/share/kinetixos-image/tool-sha256.txt
