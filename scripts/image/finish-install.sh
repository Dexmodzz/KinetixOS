...
set -euo pipefail
[[ ${1:-} == --installer-target && -f /etc/kinetixos-image ]]
[[ $(id -u) == 0 ]]
source_dir=/usr/share/kinetixos-image
...
for user in "${users[@]}"; do
	...
	[[ $home == /home/* && ! -L $home ]]
	target="$home/.local/share/kinetixos"
...
wallpaper="$HOME/Pictures/backgrounds/kinetixos.jpg"
