...
Embed this checkout and a KinetixOS Kickstart into a Fedora installer ISO.
The resulting ISO exposes the checkout at /run/install/repo/kinetixos.
...
payload_dir="$work_dir/kinetixos"
system_image_args=()
