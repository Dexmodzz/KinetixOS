...
[[ $DISTRO_ID == fedora ]] || fail "KinetixOS supports Fedora only."

# ── Detect package manager and install ───────────────────
header "Installing xscreensaver"

install_pkg() {
	command -v dnf >/dev/null 2>&1 || fail "dnf is required; KinetixOS supports Fedora only."
...
# XScreenSaver configuration — generated by KinetixOS xscreensaver-setup.sh
