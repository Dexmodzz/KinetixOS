#!/usr/bin/env python3
"""Generate KinetixOS sidebar version badges for Anaconda installer.

Creates 160x64 PNG badges with:
  - 'KinetixOS' in 20pt NotoSans-Bold (rgba(235, 235, 240, 240))
...
def render_logo(version: str, fill=DEFAULT_FILL) -> Image.Image:
    """Render a 160x64 sidebar logo badge with KinetixOS and version text.
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Generate KinetixOS sidebar version badges')
