...
Scope {
    ...
    readonly property string configDir: root.configHome + "/kinetixos"
    readonly property string policyPath: root.configDir + "/notification-settings.json"
    readonly property string cacheDir: (Quickshell.env("XDG_CACHE_HOME") || (Quickshell.env("HOME") + "/.cache")) + "/kinetixos"
