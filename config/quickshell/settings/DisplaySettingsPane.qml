            ...
            RowLayout {
                ...
                Text {
                    ...
                    text: root.confirmation === "install"
                        ? "Use saved layout '" + root.profileName + "' automatically at the next login? Administrator approval is required; the previous KinetixOS next-login layout will be backed up."
                        : "Restore the previous KinetixOS next-login layout? Administrator approval is required. This changes the next login only."
