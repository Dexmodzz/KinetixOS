...
Scope {
    ...
    readonly property string statusPath: (Quickshell.env("XDG_STATE_HOME")
        || Quickshell.env("HOME") + "/.local/state") + "/kinetixos/desktop-update/status.json"
    ...
    readonly property string updaterBootstrap: [
        ...
        "        manifest = prefix / \"share/kinetixos/desktop-install.json\"",
        "        trusted(manifest)",
        "        trusted(prefix / \"libexec/kinetixos/dwm-desktop-update-root\")",
