...
Scope {
    ...
    readonly property string themesPath: root.configHome + "/kinetixos/themes.toml"
    readonly property string wallpaperConfigPath: root.configHome + "/kinetixos/wallpaper.conf"
    readonly property string fontConfigPath: root.configHome + "/kinetixos/font.conf"
    readonly property string fontPreviewPath: root.stateHome
        + "/kinetixos/appearance/font/preview.current"
    readonly property var fontCandidates: root.inventoryCandidates.filter(function(candidate) {
        return candidate.id === "font";
    })
    readonly property string managedThemesPath: root.dataHome + "/kinetixos/config/themes.toml"
    ...
    readonly property var integrationWatchPaths: [
        ...
        root.configHome + "/kinetixos/cursor.Xresources",
        root.configHome + "/kinetixos/theme-env.sh",
    ...
    readonly property var statusWatchPaths: [
        root.stateHome + "/kinetixos/appearance/preview.current",
        root.stateHome + "/kinetixos/appearance/transaction.meta",
        root.stateHome + "/kinetixos/appearance/transaction.failed",
        root.stateHome + "/kinetixos/appearance/integration-transaction",
        root.wallpaperConfigPath,
        root.configHome + "/kinetixos/personalization.conf",
        root.stateHome + "/kinetixos/appearance/wallpaper/preview.current"
    ]
    ...
    FileView {
        path: root.configHome + "/kinetixos/personalization.conf"
        watchChanges: true
        printErrors: false
