# LightDM Slick Greeter - KinetixOS
...
The Fedora installer uses `slick-greeter`. The KinetixOS LightDM install target
...
| `wallpaper.jpg` | `/usr/share/pixmaps/kinetixos.jpg` |
