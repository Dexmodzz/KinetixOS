---
title: How KinetixOS Works
description: A plain-language guide to the window management, shell, live configuration, utilities, and multi-monitor behavior behind KinetixOS.
...
KinetixOS uses a maintained fork of
...
"patches." KinetixOS already integrates and maintains a curated set of those
...
settings backed by `${XDG_CONFIG_HOME:-$HOME/.config}/kinetixos/power.conf`.
