...
description: Learn the essential shortcuts, workspaces, and layouts for a productive first session in KinetixOS.
...
> KinetixOS is a Fedora-only X11 desktop. These instructions assume a supported
