...
state_file=$config/kinetixos/panel-widgets.conf
...
ln -s "$unsafe_target" "$unsafe_config/kinetixos"
...
mkdir -p "$writable_config/kinetixos"
chmod 777 "$writable_config/kinetixos"
...
test ! -e "$writable_config/kinetixos/panel-widgets.conf"
