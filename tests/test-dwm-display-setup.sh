...
grep -Fq 'Option "Monitor-HDMI-1" "kinetixos-HDMI-1"' "$work/generated-60.conf"
...
managed="$work/etc/X11/xorg.conf.d/90-kinetixos-display.conf"
...
settings_env=(
	...
	DWM_DISPLAY_PROFILE_DIR="$work/home/.config/kinetixos/display-profiles"
	XDG_RUNTIME_DIR="$work/runtime"
)
mkdir -p "$work/runtime"
chmod 700 "$work/runtime"
mkdir -p "$work/home/.config/kinetixos/display-profiles"
cat >"$work/home/.config/kinetixos/display-profiles/legacy.conf" <<'EOF'
...
test -f "$work/home/.config/kinetixos/display-profiles/desk.conf"
...
test ! -e "$work/home/.config/kinetixos/display-profiles/unsafe-name.conf"
test -f "$work/runtime/dwm-settings-display/rollback-failure.previous"
