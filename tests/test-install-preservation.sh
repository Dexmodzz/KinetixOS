...
printf '%s\n' '# existing hotkeys marker' >"$XDG_CONFIG_HOME/kinetixos/hotkeys.toml"
cp "$TEST_REPO/config/themes.toml" "$XDG_CONFIG_HOME/kinetixos/themes.toml"
printf '%s\n' '# existing themes marker' >>"$XDG_CONFIG_HOME/kinetixos/themes.toml"
printf '%s\n' '# existing rules marker' >"$XDG_CONFIG_HOME/kinetixos/window-rules.toml"
...
snapshot_file "$XDG_CONFIG_HOME/kinetixos/hotkeys.toml" "$WORK_DIR/hotkeys.before"
snapshot_file "$XDG_CONFIG_HOME/kinetixos/themes.toml" "$WORK_DIR/themes.before"
snapshot_file "$XDG_CONFIG_HOME/kinetixos/window-rules.toml" "$WORK_DIR/window-rules.before"
...
for _ in 1 2; do
	...
	[[ $(stat -c %a "$XDG_DATA_HOME/kinetixos/scripts/image/check-packagekit.py") == "$(stat -c %a "$TEST_REPO/scripts/image/check-packagekit.py")" ]] || {
...
assert_preserved hotkeys "$XDG_CONFIG_HOME/kinetixos/hotkeys.toml" "$WORK_DIR/hotkeys.before"
assert_preserved themes "$XDG_CONFIG_HOME/kinetixos/themes.toml" "$WORK_DIR/themes.before"
assert_preserved window-rules "$XDG_CONFIG_HOME/kinetixos/window-rules.toml" "$WORK_DIR/window-rules.before"
...
for user_path in \
	...
	"$FRESH_DATA_HOME" \
	"$FRESH_CONFIG_HOME" \
	"$FRESH_CONFIG_HOME/kinetixos" \
	"$FRESH_DATA_HOME/kinetixos"; do
