...
mkdir -p "$work/home/.config/kinetixos"
mkdir -p "$work/runtime"
printf '%s\n' 'export QT_QPA_PLATFORMTHEME=gtk3' \
	'export XCURSOR_THEME=Cursor-One' 'export XCURSOR_SIZE=32' \
	>"$work/home/.config/kinetixos/theme-env.sh"
...
mkdir -p "$work/relative-config/kinetixos"
printf '%s\n' 'export QT_QPA_PLATFORMTHEME=qt6ct' \
	'export XCURSOR_THEME=Wrong-Cursor' 'export XCURSOR_SIZE=48' \
	>"$work/relative-config/kinetixos/theme-env.sh"
(
	cd "$work"
...
mv "$work/home/.config/kinetixos/theme-env.sh" "$work/theme-env.saved"
mkfifo "$work/home/.config/kinetixos/theme-env.sh"
timeout 3 env \
	QT_QPA_PLATFORMTHEME=parent-qt XCURSOR_THEME=Parent-Cursor XCURSOR_SIZE=24 \
...
rm "$work/home/.config/kinetixos/theme-env.sh"
mv "$work/theme-env.saved" "$work/home/.config/kinetixos/theme-env.sh"
