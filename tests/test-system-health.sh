...
mkdir -p "$work/bin" "$work/home/.config/kinetixos" "$work/home/.config/quickshell"
printf 'ID=fedora\nPRETTY_NAME="Fedora Test"\n' >"$work/os-release"
: >"$work/home/.config/kinetixos/hotkeys.toml"
: >"$work/home/.config/kinetixos/themes.toml"
: >"$work/home/.config/kinetixos/window-rules.toml"
