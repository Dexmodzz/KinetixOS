...
mkdir -p "$work/status-runtime/kinetixos"
...
status_identity=$work/status-runtime/kinetixos/dwm-status.$status_key.identity
...
nested_status_identity_file=$work/status-runtime/kinetixos/dwm-status.$nested_status_key.identity
