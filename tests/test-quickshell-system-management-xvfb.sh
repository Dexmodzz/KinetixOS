...
mkdir -p "$config_home/quickshell" "$config_home/kinetixos" \
	"$data_home/kinetixos/scripts" "$runtime" "$fixture"
chmod 700 "$runtime"
...
cp "$repo/scripts/dwm-settings-provider" "$repo/scripts/dwm-quickshell-controlcenter" \
	...
	"$data_home/kinetixos/scripts/"

helper=$data_home/kinetixos/scripts/dwm-system-management
cat >"$helper" <<'HELPER'
#!/bin/sh
set -eu
...
mkdir -p "$work/discovery" "$work/discovery-data/kinetixos/scripts" "$work/discovery-state"
...
discovery_helper=$work/discovery-data/kinetixos/scripts/dwm-system-management
...
mkdir -p "$work/provider-discovery" "$work/provider-discovery-data/kinetixos/scripts" "$work/provider-discovery-state"
...
provider_discovery_helper=$work/provider-discovery-data/kinetixos/scripts/dwm-system-management
...
mkdir -p "$work/native-discovery" "$work/native-discovery-data/kinetixos/scripts" "$work/native-discovery-state"
...
native_discovery_helper=$work/native-discovery-data/kinetixos/scripts/dwm-system-management
...
mkdir -p "$work/update-ui" "$work/update-ui-data/kinetixos/scripts" "$work/update-ui-state"
...
update_ui_helper=$work/update-ui-data/kinetixos/scripts/dwm-system-management
...
mkdir -p "$work/regional-preflight-owner" "$work/preflight-data/kinetixos/scripts" "$work/preflight-empty-path"
...
preflight_helper="$work/preflight-data/kinetixos/scripts/dwm-system-management"
...
mkdir -p "$work/regional-settings" "$work/regional-settings-data/kinetixos/scripts"
...
regional_settings_helper=$work/regional-settings-data/kinetixos/scripts/dwm-system-management
...
mkdir -p "$work/delegate-confirmation" "$work/delegate-data/kinetixos/scripts"
...
delegate_helper=$work/delegate-data/kinetixos/scripts/dwm-system-management
...
mkdir -p "$work/native-action" "$work/native-action-data/kinetixos/scripts"
...
native_action_helper=$work/native-action-data/kinetixos/scripts/dwm-system-management
...
mkdir -p "$work/update-action" "$work/update-action-data/kinetixos/scripts"
...
update_action_helper=$work/update-action-data/kinetixos/scripts/dwm-system-management
...
mkdir -p "$work/operation-owner" "$work/owner-data/kinetixos/scripts" "$work/owner-state"
...
cp "$repo/tests/fixtures/system-operation-provider.py" "$work/owner-data/kinetixos/scripts/dwm-system-management"
chmod +x "$work/owner-data/kinetixos/scripts/dwm-system-management"
